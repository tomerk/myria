...
public class UserDefinedAggregator implements Aggregator {
  ...
  public UserDefinedAggregator(final ScriptEvalInterface initEvaluator, final ScriptEvalInterface updateEvaluator,
      final List<GenericEvaluator> emitEvaluators, final Schema resultSchema, final Schema stateSchema,
      final int offset) {
  ...
  public List<Column<?>> emitOutput(final TupleBatch tb) {
    ...
    TupleBatch state = tb.selectColumns(MyriaArrayUtils.range(stateCols[0], stateSchema.numColumns()));
