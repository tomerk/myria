  ...
  public void addRow(final ReadableTable from, final int fromRow, final MutableTupleBuffer to, final int toRow) {
    ...
    switch (aggOp) {
      ...
      case MIN:
        ...
        break;
      case SUM:
        toCol.replaceLong(LongMath.checkedAdd(fromCol.getInt(fromRow), toCol.getLong(toRow)), toRow);
        break;
      case SUM_SQUARED:
        toCol.replaceLong(LongMath.checkedAdd(LongMath.checkedMultiply(fromCol.getInt(fromRow), fromCol.getInt(
