...
public final class DoubleAggregator extends PrimitiveAggregator {
  ...
  @Override
  public void addRow(final ReadableTable from, final int fromRow, final MutableTupleBuffer to, final int toRow) {
    ...
    switch (aggOp) {
      case COUNT:
        ...
        break;
      case MAX:
        toCol.replaceDouble(Math.max(fromCol.getDouble(fromRow), toCol.getDouble(toRow)), toRow);
        break;
      case MIN:
        toCol.replaceDouble(Math.min(fromCol.getDouble(fromRow), toCol.getDouble(toRow)), toRow);
        break;
      case SUM:
        toCol.replaceDouble(fromCol.getDouble(fromRow) + toCol.getDouble(toRow), toRow);
        break;
      case SUM_SQUARED:
        toCol.replaceDouble(fromCol.getDouble(fromRow) * fromCol.getDouble(fromRow) + toCol.getDouble(toRow), toRow);
        break;
      default:
