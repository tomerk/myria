...
public class UserDefinedAggregatorFactory implements AggregatorFactory {
  ...
  @Override
  public List<Aggregator> generateInternalAggs(final Schema inputSchema, final int offset) throws DbException {
    return generateEmitAggs(inputSchema, offset);
  }

  @Override
  @Nonnull
  public List<Aggregator> generateEmitAggs(final Schema inputSchema, final int offset) throws DbException {
    ...
    ret.add(new UserDefinedAggregator(initEvaluator, updateEvaluator, emitEvaluators, resultSchema, stateSchema,
        offset));
    return ret;
  }
