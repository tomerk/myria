...
public final class IPCUtils {
  ...
  public static final TransportMessage CONTROL_SYSTEM_GC = TransportMessage.newBuilder().setType(
      TransportMessage.Type.CONTROL).setControlMessage(
      ControlMessage.newBuilder().setType(ControlMessage.Type.SYSTEM_GC)).build();
