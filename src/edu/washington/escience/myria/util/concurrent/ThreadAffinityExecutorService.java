...
public interface ThreadAffinityExecutorService extends ExecutorService {
  ...
  class DefaultThreadFactory implements ThreadFactory {
    ...
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(DefaultThreadFactory.class);
    ...
    public Thread newThread(final Runnable r) {
      Thread t = new Thread(ThreadAffinityExecutorService.class.getSimpleName() + "#" + ID_GENERATOR
          .getAndIncrement()) {
        @Override
        public void run() {
          r.run();
