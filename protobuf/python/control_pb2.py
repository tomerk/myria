...
SocketInfo = _reflection.GeneratedProtocolMessageType('SocketInfo', (_message.Message,), dict(
...
ResourceStats = _reflection.GeneratedProtocolMessageType('ResourceStats', (_message.Message,), dict(
